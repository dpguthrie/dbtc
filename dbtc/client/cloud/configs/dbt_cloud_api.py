...
class dbtCloudAPIRequestFactory(object):
    ...
    def _create_job_request(self) -> Dict:
        """Minimal set of required fields needed to create a new dbt Cloud job, including default values"""
        return {
            'name': None,
            'id': None,
            'execution': None,
    ...
    def create_job_request(self, data={}) -> Dict:
        ...
        Args:
          data (dict): payload to create the initial request. Typically, this will be the result of a GET on the 
             job definition from an existing job to be used for dbt Cloud migrations
        """
